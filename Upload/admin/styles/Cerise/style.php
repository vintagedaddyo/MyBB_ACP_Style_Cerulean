...
//]]>
	...
	function output_footer($quit=true)
	{
		...
		echo "<div id=\"footer\"><p class=\"generation\">".$lang->sprintf($lang->generated_in, $totaltime, $debuglink, $querycount, $memory_usage)."</p><p class=\"powered\">Powered By <a href=\"https://mybb.com/\" target=\"_blank\" rel=\"noopener\">MyBB</a>, &copy; 2002-".COPY_YEAR." <a href=\"https://mybb.com/\" target=\"_blank\" rel=\"noopener\">MyBB Group</a> All Rights Reserved.&nbsp;&nbsp;Theme \"Cerise ACP\" created by <a href=\"https://github.com/vintagedaddyo/MyBB_ACP_Style_Cerulean\" target=\"_blank\"><b>Vintagedaddyo</b></a>&nbsp;&amp;&nbsp;<a href=\"http://community.mybb.com/user-78269.html\" target=\"_blank\"><b>Wage</b></a>.</p></div>\n";
		if($mybb->debug_mode)
		{
			echo $db->explain;
		}
